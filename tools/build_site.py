...
<body>
  ...
  <main id="top">
    ...
    <section><div class="wrap"><div class="section-intro"><div><div class="eyebrow">Source notes</div><h2>Made to be explored.</h2></div><p>Original pixel art is authored in the shared renderer. No remote services, external fonts, tracking scripts, or generated concept images are included in this showcase.</p></div><div class="panel"><p>Selected project documents: {docs_html or '<span class="muted">none copied</span>'}</p><p class="muted">The native captures are not a hardware certification. Current results and remaining device checks are in VERIFICATION.md.</p></div></div></section>
  </main>
